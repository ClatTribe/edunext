  ...
  const Sidebar = () => (
    <div className="w-64 bg-pink-50 h-screen p-4 border-r border-pink-200">
      ...
      <div className="flex items-center gap-2 mb-6">
        ...
        <div className="text-red-600 font-semibold">{getUserName()}</div>
      </div>
      ...
      <nav className="space-y-2">
        ...
        {user && (
          <button 
            onClick={signOut}
            className="flex items-center gap-3 p-2 w-full text-left hover:bg-white rounded-lg text-red-600 mt-4"
          >
            <LogOut size={18} />
            <span>Logout</span>
          </button>
