...
const ApplicationBuilderPage = () => {
  ...
  const checkUserProgress = async () => {
    try {
      ...
      const { data: profileData } = await supabase
        .from('admit_profiles')
        .select('name, degree, last_course_cgpa')
        .eq('user_id', user?.id)
        .single();
      ...
      setProgress({
        ...
        documentUpload: false, // TODO: Check when document upload is implemented
        documentVerification: false, // TODO: Check when verification is implemented
        documentVerified: false, // TODO: Check when verified
  ...
  const stages = [
    ...
    },
    {
      ...
      action: null,
      actionText: 'Pending Verification'
    },
    {
      id: 'documentVerified',
      ...
      locked: !progress.documentVerification,
      action: null,
      actionText: 'Verified'
    },
    {
      ...
      action: () => alert('Final steps coming soon!'),
