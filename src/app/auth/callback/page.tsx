    ...
    const handleCallback = async () => {
      try {
        ...
        if (!data.session?.user) {
          router.push('/register?error=no_session');
          return;
        }
        ...
        // If profile doesn't exist, wait a moment for trigger to create it
        if (!profile) {
          await new Promise(resolve => setTimeout(resolve, 1000));
          ...
          if (!retryProfile) {
            ...
            // Profile will be created by AuthContext if needed
          }
        }
        ...
        setTimeout(() => {
          router.push('/register?error=unexpected');
        }, 1500);
      }
    };
      ...
      <div className="bg-white rounded-2xl shadow-2xl p-12 max-w-md w-full mx-4">
        <div className="text-center">
          ...
          <h2 className="text-2xl font-bold text-red-600 mb-2">
            {status.includes('failed') ? 'Oops!' : 'Almost There!'}
          </h2>
