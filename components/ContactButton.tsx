  ...
  return (
    <div ref={containerRef} className="fixed bottom-4 right-6 z-50">
      ...
      >
        ...
        <button
          onClick={handleCall}
          className="flex items-center gap-2 bg-white hover:bg-blue-50 text-gray-800 px-3 py-2 rounded-full shadow-lg hover:shadow-xl transition-all duration-200 group border border-blue-200 animate-slideUp"
          style={{ animationDelay: '0.1s' }}
        >
          <div className="w-8 h-8 bg-gradient-to-br from-[#0054D1] to-[#003BA3] rounded-full flex items-center justify-center group-hover:scale-110 transition-transform">
      ...
      >
        ...
        {!isOpen && (
          <div className="absolute inset-0 rounded-full bg-[#0054D1] animate-ping opacity-20"></div>
        )}
      </button>
