          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="mb-10 animate-in fade-in slide-in-from-bottom-4 duration-700">
              ...
              <h1 className="text-4xl md:text-6xl font-extrabold mb-4 bg-clip-text text-transparent bg-gradient-to-r from-white via-white to-slate-400">
                JEE <span className="text-[#f9a01b]">Starter Kit.</span>
              </h1>
              <p className="text-slate-400 text-lg max-w-2xl leading-relaxed">
                Master the JEE syllabus with structured study materials, expert
                problem-solving strategies, and real-time updates. Join the
                community and secure your seat in the IITs.{" "}
              </p>
            </div>
