  ...
  const pyqData: PYQData[] = [
    {
      ...
      description: "CUET 2025 memory-based question paper with section-wise analysis.",
    },
    {
      year: 2024,
      driveLink: "https://drive.google.com/file/d/1L-a-yhn6y__oR1DiiKpKso_lDJzVlC33/view?usp=drive_link",
      description: "CUET 2024 paper set with answer key references and topic mapping.",
    },
    {
      year: 2023,
      driveLink: "https://drive.google.com/file/d/1bWhFsNtZ4R2vf2P38HHtkDjbOOUQb2-M/view?usp=drive_link",
      description: "CUET 2023 previous paper compilation for language, domain, and general test.",
    },
    {
      year: 2022,
      driveLink: "https://drive.google.com/file/d/1mv5CpIZ230Fju5rweOhuI8C8ZqG5nk46/view?usp=drive_link",
      description: "CUET 2022 baseline paper set to understand exam pattern and difficulty.",
    },
  ];
  ...
  return (
    <div className="space-y-6">
      <div className="text-center mb-8">
        <h2 className="text-3xl sm:text-4xl font-extrabold text-white mb-3">Previous Year Question Papers</h2>
      </div>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {pyqData.map((paper) => (
          ...
          >
            ...
            <h3 className="text-xl font-bold text-white mb-2">CUET {paper.year} Question Paper</h3>
            <p className="text-slate-400 text-sm mb-6 line-clamp-3">{paper.description}</p>
            <div className="flex items-center gap-3">
              ...
              <button
                onClick={() => window.open(paper.driveLink, "_blank")}
