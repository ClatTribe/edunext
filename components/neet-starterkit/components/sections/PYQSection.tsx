...
export const PYQSection: React.FC = () => {
  const pyqData: PYQData[] = [
    ...
    },
    {
      ...
      description: 'NEET Main 2024 Shift 1 - January 27. Complete paper with answer key and step-by-step solutions.'
    },
    {
      year: 2023,
      driveLink: 'https://drive.google.com/file/d/1bWhFsNtZ4R2vf2P38HHtkDjbOOUQb2-M/view?usp=drive_link',
      description: 'NEET Main 2023 Shift 1 - January 24. Official questions with detailed explanations for all sections.'
    },
    {
      year: 2022,
      driveLink: 'https://drive.google.com/file/d/1mv5CpIZ230Fju5rweOhuI8C8ZqG5nk46/view?usp=drive_link',
      description: 'NEET Main 2022 Shift 1 - June 24. Comprehensive paper with answer key and pattern analysis.'
    },
    {
      year: 2021,
      driveLink: 'https://drive.google.com/file/d/1IhlaH342KJt1gsCme2uSLJQ7IaAWIqEU/view?usp=drive_link',
      description: 'NEET Main 2021 Shift 1 - February 24. Complete question paper with detailed solutions and tips.'
    },
    {
      year: 2020,
      driveLink: 'https://drive.google.com/file/d/1L6tPrEU5kX4S7Lesyg4d1EjDGGJV8KLC/view?usp=drive_link',
      description: 'NEET Main 2020 Shift 1 - January 7. Full paper with answer key and subject-wise breakdown.'
    }
  ];
