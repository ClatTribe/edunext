    ...
    <div className="flex flex-col h-full bg-white rounded-xl border border-slate-200 shadow-2xl overflow-hidden">
      <div className="p-8 border-b border-slate-100 bg-white">
        ...
        <div className="flex gap-4 mb-8">
           <button className="bg-[#2f61ce] text-white px-6 py-3 rounded-lg font-bold text-sm flex items-center gap-2 shadow-lg shadow-red-200 hover:bg-blue-600 transition-colors">
        ...
        <div className="flex gap-4">
           <div className="relative flex-1 group">
             <input 
                ...
                className="w-full border border-slate-200 rounded-lg pl-5 pr-12 py-4 text-slate-700 focus:ring-2 focus:ring-red-100 focus:border-[#2f61ce] transition-all outline-none text-lg" 
             />
             <Search className="absolute right-4 top-4.5 text-slate-400 group-focus-within:text-[#2f61ce] transition-colors" size={24} />
           </div>
           <button className="bg-[#2f61ce] text-white px-8 py-4 rounded-lg font-bold flex items-center gap-2 shadow-lg shadow-red-200 hover:bg-blue-600 transition-colors">
