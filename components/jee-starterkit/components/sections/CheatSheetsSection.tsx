...
import { ShieldCheck, Scale, Globe, GlassWater, Eye, Download, type LucideIcon } from "lucide-react";
  ...
  const sheets = [
    {
      ...
      color: "text-blue-400",
      bg: "bg-blue-400/10",
      subtitle: "Key Laws & Derivation summaries",
      driveLink:
    ...
    },
    {
      ...
      color: "text-[#f9a01b]",
      bg: "bg-orange-400/10",
      subtitle: "Essential Calculus & Algebra formulas",
      driveLink:
    ...
    },
    {
      ...
      bg: "bg-green-400/10",
      subtitle: "Organic Reactions & Periodic trends",
      driveLink:
    ...
    {
      title: "Syllabus for JEE",
      icon: ShieldCheck,
      color: "text-purple-400",
      bg: "bg-purple-400/10",
      subtitle: "High-weightage topics & priority list",
      driveLink:
      ...
      <div className="bg-slate-900/30 border border-slate-800 p-8 rounded-3xl mb-8 flex flex-col md:flex-row items-center gap-8">
        <div className="flex-1">
          <p className="text-slate-400 leading-relaxed">
            ...
            high-yield formulas and visual maps. Perfect for cracking JEE Mains
            and Advanced under pressure.
          </p>
        </div>
