  ...
  return (
    <div className="space-y-10">
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-2xl font-bold mb-1">Explore Universities</h2>
          <p className="text-slate-500 text-sm">Find your target university and compare essential admission metrics.</p>
        </div>
        <button className="text-sm font-bold text-[#f9a01b] hover:underline">Compare All Universities</button>
      </div>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-8">
        {COLLEGES_DATA.map((college, i) => (
          <div
            key={i}
            className="group bg-[#0d111d] rounded-[2rem] border border-slate-800 overflow-hidden hover:border-slate-700 transition-all flex flex-col"
          >
            ...
            <div className="p-8 flex-1 flex flex-col">
              ...
              <p className="text-slate-400 text-sm leading-relaxed mb-8 flex-1">{college.description}</p>
