...
export const TAB_SEO: Record<ExamTab, TabSEO> = {
  ...
  [ExamTab.IPM]: {
    ...
    description:
      "Track all IPM registration dates, form deadlines, and exam schedules in one place. Covers IPMAT Indore, IPMAT Rohtak, JIPMAT, and other IPM entrance exams.",
    keywords:
      "IPM form 2026, IPMAT registration, IPM exam date, IPM deadline, IIM admission, JIPMAT, EduNext",
  },
};
...
export const FORMS_BY_TAB: Record<ExamTab, ExamFormEntry[]> = {
  ...
  [ExamTab.IPM]: [
    ...
    },
    {
      ...
      courses: "IPM (5-Years) / BBA Hons (4-Years) | Accepts: IPMAT / JIPMAT / JEE / SAT",
    },
    {
      name: "Bennett University",
      startDate: "To be announced",
      endDate: "May 15, 2026 (Tentative)",
      status: "Open",
      link: "https://applications.bennett.edu.in/bu?utm_source=Consultant&utm_medium=VIVEK+SHUKLA(GURU+MANTRA)/2026-28/407&utm_campaign=Without+Coupon",
      courses: "BBA + MBA (5-Years)",
    },
    {
      ...
      endDate: "Apr 15, 2026",
      status: "Open",
      link: "https://set2026.ishinfosys.com/SYM20-SET26/apply/Index.aspx",
