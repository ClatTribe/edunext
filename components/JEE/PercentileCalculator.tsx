...
export default function PercentileCalculator({ userScore, userName }: PercentileCalculatorProps) {
  ...
  const calculatePercentile = async () => {
    try {
      ...
      const allScores = allResults.map((entry) => {
  ...
  if (loading) {
    return (
      <div className="rounded-2xl p-6 shadow-xl animate-pulse" style={{ backgroundColor: secondaryBg, border: `1px solid ${borderColor}` }}>
  ...
  return (
    <div className="rounded-2xl p-6 shadow-xl" style={{ backgroundColor: secondaryBg, border: `1px solid ${borderColor}` }}>
      ...
      <div className="bg-[#050818] rounded-xl p-8 mb-6 text-center border-2" style={{ borderColor: accentColor }}>
      ...
      <div className="grid grid-cols-2 gap-4 mb-6">
        ...
        <div className="bg-[#050818] rounded-xl p-4 border border-slate-700">
          ...
          <p className="text-3xl font-bold" style={{ color: accentColor }}>{userScore}</p>
