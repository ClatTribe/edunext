  ...
  return (
    <div className="flex flex-col h-full bg-white rounded-xl border border-slate-200 shadow-2xl overflow-hidden">
      <div className="p-8 border-b border-slate-100 bg-white">
        <h3 className="text-3xl font-bold text-[#2f61ce] mb-2 tracking-tight">Find Scholarships to Fuel Your Dreams</h3>
        <p className="text-slate-500 mb-8 text-lg">Discover scholarships from top universities and institutions Nationwide</p>
         ...
         {loading ? (
           ...
           <div className="space-y-3">
              {scholarships.map((scholarship) => (
                <div key={scholarship.id} className="bg-white p-5 rounded-xl border border-slate-200 shadow-sm hover:shadow-md transition-shadow">
                   <div className="mb-3">
